...
```
제작완료 → 체크리스트작성 → 1차승인 → 2차최종승인 → 이관완료 → 양산시작
    ↓           ↓            ↓           ↓            ↓           ↓
 maker       maker        생산처    금형개발담당     자동처리     plant
```
...
| 2차 | 금형개발 담당 | 최종 승인/반려 | `pending_final_approval` |
...
| 기능 | system_admin | mold_developer | maker | plant |
|------|:------------:|:--------------:|:-----:|:-----:|
| 체크리스트 마스터 관리 | ✅ | ⬜ | ⬜ | ⬜ |
| 이관 신청 | ⬜ | ⬜ | ✅ | ⬜ |
| 체크리스트 작성 | ⬜ | ⬜ | ✅ | ⬜ |
