...
const MAKER_GPS = [
  ...
  ['E0018', 37.1925, 126.8135],  // 제일솔루텍 - 화성시 남양읍
  ['C5389', 35.0735, 126.8050],  // 현태금형 - 광주 광산구 하남산단
  ['C1134', 35.1815, 126.8950],  // 상봉정밀 - 광주 북구 월출동
  ['C1531', 35.1320, 126.7985],  // 제일산기 - 광주 광산구 도천동
  ['C1853', 35.2260, 126.8430],  // 아이앤테크 - 광주 북구 첨단연신로
  ['C1133', 35.5920, 129.3210],  // 한국몰드 - 울산 북구 단청동
  ['C2406', 37.3985, 126.7310],  // 두성정공 - 인천 남동구
  ['E0191', 35.0935, 128.9365],  // 에스엠정밀기술 - 부산 강서구 과학산단
  ['C6425', 37.1165, 126.9550],  // 창대정밀 - 화성시 양감면
  ['C7853', 35.6125, 129.3485],  // 동신산업(울산) - 울산 북구 매곡산업
  ['C0809', 36.9640, 127.0285],  // 동신산업(평택) - 평택시 팽성읍
  ['C1308', 35.3125, 128.7680],  // 신혁2공장 - 김해시 진영읍
  ['C1354', 35.6100, 129.3410],  // 진흥공업 - 울산 북구 매곡동
  ['E0239', 35.7865, 129.3540],  // 디에스메탈 - 경주시 외동읍
  ['E0249', 35.0890, 126.7560],  // 에스에스몰드 - 광주 광산구 진곡산단
];
